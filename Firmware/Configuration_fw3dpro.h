#ifndef CONFIGURATION_FW3DPRO_H
#define CONFIGURATION_FW3DPRO_H
...
// Printer name
#define CUSTOM_MENDEL_NAME "FW 3DPro"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3200/4,161.3} // FW 3DPro with 2 thread Z steppers
...
#define EXTRUDER_0_AUTO_FAN_PIN   7 //8
...
#if MOTHERBOARD == 102 || MOTHERBOARD == 302 || MOTHERBOARD == 33
...
#endif //__CONFIGURATION_FW3DPRO_H
